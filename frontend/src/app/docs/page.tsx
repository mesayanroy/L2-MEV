...
export default function DocsPage() {
  return (
    <div className="page-wrap py-14">
      ...
      <section className="mt-16 max-w-none rounded border border-gray-300 bg-gray-100 p-8">
        <h2 className="text-2xl font-bold text-gray-900">What is MEV?</h2>
        ...
        <h3 className="mt-8 text-xl font-semibold text-gray-900">Sandwich attacks explained</h3>
        ...
        <ol className="mt-3 list-decimal space-y-1 pl-6 text-gray-800">
        ...
        <h3 className="mt-8 text-xl font-semibold text-gray-900">How L2-MEV Shield stops it</h3>
